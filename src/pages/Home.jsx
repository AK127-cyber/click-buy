    ...
    <div className="home">
      ...
      <section className="best-selling">
        ...
        <Link
          ...
          state={{
            name: "Natural Plant",
            price: 260,
            image: "https://shrigramorganics.com/wp-content/uploads/2020/06/51OukLdAS5L.jpg",
            description: "This is a beautiful natural plant. Great for your home or office."
          }}
        >
          ...
          state={{
            name: "Natural Plant",
            price: 400,
            image: "https://www.satyamkraft.in/cdn/shop/products/51GK4guXorL_500x500.jpg?v=1712215620",
            description: "This is a beautiful natural plant. Great for your home or office."
          }}
        >
          <div className="plant-item">
           ...
           state={{
            name: "Natural Plant",
            price: 310,
            image: "https://i.pinimg.com/originals/54/c9/8f/54c98fcf8fc553fb7fe8903a380eef4f.jpg",
            description: "This is a beautiful natural plant. Great for your home or office."
           }}
      ...
      <section className="categories">
        ...
        <div className="category-list">
         ...
         <Link to="shop">
         <button className="explore">Explore</button></Link>
      </section>
