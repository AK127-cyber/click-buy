        ...
        <div className="delete-items-page">
            ...
            <div className="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="/admin/add-items">Add Items</a></li>
                    <li><a href="/admin/edit-items">Edit Items</a></li>
                    <li><a href="/admin/delete-items" className="active">Delete Items</a></li>
                    ...
                    <tbody>
                        {items.map((item) => (
                            <tr key={item.id}>
                                ...
                                <td>{item.category}</td>
                                <td>
                                    <button className="btn edit-btn" onClick={() => navigate("/admin/edit-items")}>Edit</button>
                                    <button className="btn delete-btn" onClick={() => deleteItem(item.id)}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
